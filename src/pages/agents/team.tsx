...
function PerformanceCard() {
  ...
  const exportCsv = (rowsToExport: CsvRow[], filename: string) => {
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        if (next === 'all' || next === 'zone' || next === 'type') setFilterMode(next);
                      }}
                    >
      ...
      <CardHeader className="flex items-center justify-between">
        ...
        <div className="flex gap-2 items-center">
          ...
          <select
            ...
            onChange={(e) => {
              const next = e.target.value;
              if (next === 'all' || next === '7d' || next === '30d') onDateRange(next);
            }}
          >
                  ...
                  <select
                    ...
                    onChange={(e) => {
                      ...
                      if (
                        ...
                        handleRoleChange(member.id, next);
                      }
                    }}
                  >
